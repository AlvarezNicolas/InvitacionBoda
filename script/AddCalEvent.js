        ...
        _createHtml: function(isValid) {
            ...
            for(var i=0,j=this.options.linkText.length;i<j;i++) {
                if(this._isLinkNeeded(i)) {
                    optionLinks += '<a class="ace_opt dropdown-item" data-ace-id="'+ i +'" href="javascript:;">' + this.options.linkText[i] + '</a>';
                }
            }
            return '<div class="ace_dd dropdown-menu" style="' + styleString + '">' + optionLinks + '</div>';
        },
